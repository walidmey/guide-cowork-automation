...
{% hint style="info" %}
Cette page décrit comment Cowork passe à l'action. Chaque mode correspond à une façon différente de travailler avec lui — de la conversation simple aux enchaînements automatisés.
{% endhint %}
...
{% hint style="success" %}
Exemple : demandez à Cowork de rédiger un résumé clair à partir d'un PDF déjà présent dans votre projet.
{% endhint %}
...
{% hint style="success" %}
Exemple : demandez à Cowork de lire vos derniers emails Gmail non lus et d'en extraire les actions urgentes.
{% endhint %}
...
{% hint style="success" %}
Exemple : demandez à Cowork de remplir un formulaire dans un outil interne qui n'a ni API ni connecteur.
{% endhint %}
...
{% hint style="success" %}
Exemple : demandez à Cowork d'analyser tous les CSV d'un dossier puis de sauvegarder une synthèse dans vos fichiers de travail.
{% endhint %}
...
{% hint style="warning" %}
Choisir le bon mode fait toute la différence. Un bon usage de Cowork commence par identifier ce que vous voulez déléguer — et à quel niveau d'autonomie.
{% endhint %}
